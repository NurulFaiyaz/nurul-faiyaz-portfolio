...
const Skill = () => {
    return (
        <div className="space-y-2 md:space-y-4">
            <h2 className="text-2xl md:text-4xl font-bold text-center ">Skill</h2>
            <div className="flex justify-evenly flex-wrap gap-5">
                <img src="https://img.icons8.com/?size=100&id=20909&format=png&color=000000" alt="Html5" />
                <img src="https://img.icons8.com/?size=100&id=7gdY5qNXaKC0&format=png&color=000000" alt="Css3" />
                ...
                <img src="https://img.icons8.com/?size=100&id=bosfpvRzNOG8&format=png&color=000000" alt="Mongo Db" />
            </div>
        </div>
    );
};
